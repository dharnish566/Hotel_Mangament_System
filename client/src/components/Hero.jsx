...
const Hero = () => {
    ...
    const onSearch = async (e)=> {
        ...
        setSearchedCities((prevSearchCities)=>{
            const updatedSearchedCities = [...prevSearchCities , destination];
    ...
    xl:px-32 text-white bg-[url("/src/assets/heroimage.webp")] bg-no-repeat bg-cover
    bg-center h-screen '>

            <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>The Ultimate Hotel Experience</p>
            <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px]5519
    font-bold md:font-extrabold max-w-xl mt-4'>Discover Your Perfect Gateway Destination</h1>
            <p className='max-w-130 mt-2 text-sm md:text-base text-black'>Unparalleled lyxury and comfort await at the world's most exclusive hotels and resorts.
