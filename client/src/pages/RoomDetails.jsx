...
const RoomDetails = () => {
    ...
    const checkAvailability = async () => {
        try{
            ...
            // Check is Check-In Date is greatår than Check-Out Date
  ...
  return (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 x1:px-32'>
        ...
        shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            <button type='sumbit' className='bg-primary hover: bg-primary-dull active:scale-95 transition-all text-white 
